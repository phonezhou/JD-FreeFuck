...
## 项目地址
JD_BASE_URL="https://gitee.com/phonezhou/JD-FreeFuck.git"
## 活动脚本库私钥
...
function UseNotes() {
    ...
    echo -e "\033[32m +-----------------------------------------------------------------------------------------------------------------+ \033[0m"
    echo -e ''
    echo -e "\033[32m ============================ 更多帮助请访问 https://github.com/phonezhou/JD-FreeFuck ============================ \033[0m"
    echo -e "\033[32m ============================ Github & Gitee https://gitee.com/phonezhou/JD-FreeFuck  ============================ \033[0m"
    echo -e ''
}
